		...
		<div class="ts-fab-avatar">';
			...
			$ts_fab_bio .= '<div class="ts-fab-social-links">';
				...
				if ( get_user_meta( $author->ID, 'ts_fab_stack_overflow', true ) ) {
					...
					$ts_fab_bio .= '<a href="' . esc_attr( $ts_fab_stack_overflow_url ) . '" title="Stack Overflow" rel="nofollow"><img src="' . plugins_url( 'images/stack_overflow.png', dirname(__FILE__) ) . '" width="24" height="24" alt="' . __( 'My StackOverflow profile', 'ts-fab' ) . '" /></a>';
				}
